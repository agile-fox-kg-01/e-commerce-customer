    ...
    <div :class="cClass">
      <div class="cart-menu">
        ...
        <transition-group name="fade">
          <div class="row" v-for="product in cartContent" :key="product.ProductId">
            <div class="col4 col-xl-4 col-lg-4 col-md-4 col-sm-4">
              <img :src="product.Product.imageURL" style="width: 90px;">
            </div>
            ...
            <div class="col2 col-xl-2 col-lg-2 col-md-2 col-sm-2 pt-4">
              <span class="remove-btn" @click="removeThing(product.ProductId)">remove</span>
            </div>
          </div>
        </transition-group >
        ...
        <div class="row justify-content-between" style="background:#7dcf85;padding:10px 10px 10px 10px" v-if="this.cartPrice != undefined">
          ...
          <div class="flex-column pr-3">
            <h4>Rp. {{ cartPrice.toLocaleString() }}</h4>
          </div>
        </div>
      </div>
    </div>
