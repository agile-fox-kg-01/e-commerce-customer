    ...
    <div class="row justify-content-around">
      ...
      <div class="row col-6 flex-row-reverse">
        <div class="view-button">
          <div class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="MenuLink" v-for="category in getCategories" :key="category.id">
              <a class="dropdown-item" @click="sortI(category.name)">{{ category.name }}</a>
      ...
      <div class="row justify-content-center">
        ...
        <div class="row col-xl-9 col-lg-9 col-md-12 col-sm-12 col-xs-12 text-center">
          <div v-if="getProducts.length === 0" class="col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h4 style="margin-left:9rem;margin-right:9rem">Sorry, we can't find a product with this features</h4>
          </div>

            <Card :Products="getProducts" />
